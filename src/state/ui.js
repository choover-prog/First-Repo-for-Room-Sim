...
export function setCollapse(zone, val){
  ...
  window.dispatchEvent(new CustomEvent('ui:change', { detail: { key: `collapse.${zone}`, value: val } }));
}
...
export function setFullscreen(val){
  ...
  window.dispatchEvent(new CustomEvent('ui:change', { detail: { key: 'fullscreen', value: val } }));
}
